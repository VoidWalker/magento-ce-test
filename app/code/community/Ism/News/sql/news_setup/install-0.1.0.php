...
$table = $installer->getConnection()->newTable($installer->getTable('news/news'))
    ...
    ->addColumn('is_published', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(), 'News status')
...
$installer->run("INSERT INTO `{$installer->getTable('news/news')}` VALUES (2,'My New Title2','This is a news post2','News Announce2','2009-08-02 23:12:30', 1);");
$installer->endSetup();